...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Cuentas x cobrar Tarjetas</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                            ...
                            <table id="tb_cobranzas" class="table table-bordered table-striped">
                                ...
                                @foreach ($cuentasxcobrar as $key=>$cobrar)
                                    <tr cuentasxcobrarinscripcionid="{{$cobrar['id']}}" id="tr_{{$cobrar['id']}}">
                                        ...
                                        <td>{{$cobrar['anio']}}</td>
                                        <td>{{$cobrar['fecha_partido']}}</td>
                                        <td class="tipotarjeta">{{$cobrar['tipo_tarjetas']}}</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><b id="titulomodal">Cobrar</b> Tarjeta <em id="tipotarjeta"></em></h4>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="input-group mb-3" style="margin-bottom: 0 !important;">
                                                    ...
                                                    <input disabled type="number" min="1" max="35" id="monto_pagar" class="form-control" aria-label="Amount (to the nearest pen)">
...
<script>
    ...
    $(document).on('click', '#tb_cobranzas tbody tr td.btncobranza button', function(){
        var pad = $(this).parents('tr')
        $('#tipotarjeta').html(pad.find('td.tipotarjeta').html())
        $('#monto_pagar').val(pad.find('td.mpendiente').html())
    })
</script>
@endsection