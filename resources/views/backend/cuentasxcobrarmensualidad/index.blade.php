...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Cuentas x cobrar Cuota Mensual</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                            ...
                            <table id="tb_cobranzas" class="table table-bordered table-striped">
                                ...
                                @foreach ($cuentasxcobrar as $key=>$cobrar)
                                    <tr cuentasxcobrarinscripcionid="{{$cobrar['id']}}" id="tr_{{$cobrar['id']}}">
                                        ...
                                        <td>
                                        @php
                                            $dia =(int) date("m",strtotime($cobrar['mes']));
                                            echo getmes($dia);
                                        @endphp
                                        </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><b id="titulomodal">Cobrar</b> Couta Mensual</h4>
                ...
                <div class="modal-body">
                    <div class="card card-primary" id="cont_cobranza">
                        ...
                        <div class="card-body" style="padding: 0.25rem 1.25rem 0.25rem 1.25rem;">
                            ...
                            <h3 id="secobrotxt" class="text-center d-none">Se cobro la Couta Mensual</h3>
                        </div>
                    </div>
